...
app.post('/api/newsletter/subscribe', async (req, res) => {
  try {
    ...
    if (subscriber.beats || subscriber.loops || subscriber.mixing) await sendMusicInterestThankYouEmail(subscriber);
...
app.put('/api/newsletter/subscribers/:id', async (req, res) => {
  try {
    ...
    const boolFields = ['beats', 'mixing', 'loops', 'visuals', 'web', 'ads'];
